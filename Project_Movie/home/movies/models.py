...
class Movies(models.Model):
    ...
    movie_poster = models.CharField(max_length=255, verbose_name='海报')
    movie_type = models.IntegerField(verbose_name='类型（关联基础数据表dict_type="movie_type"）')
    movie_region = models.IntegerField(verbose_name='区域（关联基础数据表dict_type="movie_region"）')
    movie_duration = models.IntegerField(verbose_name='时长')
    movie_release_date = models.DateTimeField(verbose_name='上映时间', null=True)
    movie_era = models.IntegerField(verbose_name='年代（关联基础数据表dict_type="movie_era"）')
    movie_description = models.CharField(max_length=255, verbose_name='剧情介绍')
    movie_score_num = models.IntegerField(verbose_name='评分人数')
    movie_box_office = models.DecimalField(max_digits=11, decimal_places=2, verbose_name='票房')
    movie_anticipate = models.IntegerField(verbose_name='想看数')
    movie_status = models.IntegerField(verbose_name='电影状态（关联基础数据表dict_type="movie_status"）')
...
class Information(models.Model):
    ...
    id = models.AutoField(primary_key=True, verbose_name='资讯id')
    create_time = models.DateTimeField(verbose_name='创建时间', null=True)
    update_time = models.DateTimeField(verbose_name='更新时间', null=True)
    delete_time = models.DateTimeField(verbose_name='删除时间', null=True)
    title = models.CharField(max_length=128, verbose_name='标题')
    image = models.CharField(max_length=255, verbose_name='图片')
    type = models.IntegerField(verbose_name='类型（关联基础数据表，0：资讯；1：广告）')
...
class Cast(models.Model):
    ...
    role = models.CharField(max_length=32, verbose_name='饰演角色')
